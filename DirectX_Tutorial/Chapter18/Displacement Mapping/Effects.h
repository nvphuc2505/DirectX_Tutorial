...
{
public:
	BasicEffect(ID3D11Device* device, LPCWCHAR filename);
	~BasicEffect();
...
{
public:
	NormalMapEffect(ID3D11Device* device, LPCWCHAR filename);
	~NormalMapEffect();
...
{
public:
	DisplacementMapEffect(ID3D11Device* pd3dDevice, LPCWCHAR filename);
...
{
public:
	SkyEffect(ID3D11Device* pd3dDevice, LPCWCHAR filename);
	~SkyEffect();
