	...
	void* pUserContext)
{
	...
	// Car
	//
	g_CarMaterial.Ambient = XMFLOAT4(0.4f, 0.4f, 0.4f, 1.0f);
	g_CarMaterial.Diffuse = XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
	...
	double fTime, float fElapsedTime, void* pUserContext)
{
	...
	ID3DX11EffectTechnique* activeCarTech = Effects::BasicFX->Light3Tech;
