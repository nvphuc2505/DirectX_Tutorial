...
const D3D11_INPUT_ELEMENT_DESC InputLayoutDesc::PosNormalTexTan[6] =
{
	{"POSITION",     0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0,  D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"NORMAL",       0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"TEXCOORD",     0, DXGI_FORMAT_R32G32_FLOAT,    0, 24, D3D11_INPUT_PER_VERTEX_DATA, 0},
...
void InputLayouts::InitAll(ID3D11Device* device)
{
	...
	HRESULT hr = (device->CreateInputLayout(InputLayoutDesc::Pos, 1, passDesc.pIAInputSignature,
	...
	// NormalMapSkinned
	//
	Effects::NormalMapFX->Light3TexSkinnedTech->GetPassByIndex(0)->GetDesc(&passDesc);
	hr = (device->CreateInputLayout(InputLayoutDesc::PosNormalTexTan, 6, passDesc.pIAInputSignature,
