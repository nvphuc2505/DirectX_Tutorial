#include "D:/Work/Direct3D11/Exc/Chapter12/Blur/FX/LightingHelper.fx"
...
float4 PS(VertexOut vout, uniform int gLightCount, uniform bool gUseTexure, uniform bool gAlphaClip, uniform bool gFogEnabled) : SV_Target
{
    ...
    if (gLightCount > 0)
    {
        ...
        {
            float4 A, S, D;
            ComputeDirectionalLight(gMaterial, gDirLights[i], vout.NormalW, toEye, A, D, S);
            ambient += A;
            diffuse += D;
            spec += S;
        }
