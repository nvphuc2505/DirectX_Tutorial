	...
	: mFX(0)
{
	...
	WCHAR str[MAX_PATH];
	HRESULT hr = (DXUTFindDXSDKMediaFileCch(str, MAX_PATH, L"D:/Work/Direct3D11/Exc/Chapter09/FX/Basic.fx"));
...
{
	BasicFX = new BasicEffect(device, L"D:/Work/Direct3D11/Exc/Chapter09/FX/Basic.fx");
}
