	...
	void* pUserContext)
{
	...
	XMStoreFloat4x4(&g_BoxWorld, boxOffset);
	...
	hr = DXUTCreateShaderResourceViewFromFile(pd3dDevice, L"D:/Work/Direct3D11/Exc/Chapter09/Textures/grass.dds", &g_GrassMapSRV);
	hr = DXUTCreateShaderResourceViewFromFile(pd3dDevice, L"D:/Work/Direct3D11/Exc/Chapter09/Textures/water2.dds", &g_WaterMapSRV);
	hr = DXUTCreateShaderResourceViewFromFile(pd3dDevice, L"D:/Work/Direct3D11/Exc/Chapter09/Textures/WireFence.dds", &g_WoodCrateMapSRV);
	...
	double fTime, float fElapsedTime, void* pUserContext)
{
	...
	switch (g_RenderOptions)
	{
	case RenderOptions::Lighting:
		boxTech = Effects::BasicFX->Light1Tech;
		landAndWavesTech = Effects::BasicFX->Light1Tech;
		break;
